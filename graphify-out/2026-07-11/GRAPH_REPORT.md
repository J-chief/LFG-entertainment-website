# Graph Report - LFG Gemini Front end  (2026-07-11)

## Corpus Check
- 38 files · ~2,113,427 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 280 nodes · 330 edges · 21 communities (18 shown, 3 thin omitted)
...
Cohesion: 0.11
Nodes (17): CheckoutFormValues, checkoutSchema, currentDate, TicketsOverlay(), upcomingEvents, mockGalleries, testimonials, Artist (+9 more)
...
Cohesion: 0.13
Nodes (11): inter, metadata, spaceGrotesk, CursorTrail(), Particle, FLASH_IMAGES, MorphData, SmoothScrollProvider() (+3 more)
...
Cohesion: 0.12
Nodes (20): EventsPage(), EventDetailPage(), VENUE_IMAGES, LfgNationPage(), HomePage(), MOSAIC_IMAGES, Header(), NAV_LINKS (+12 more)

## Knowledge Gaps
- **171 isolated node(s):** `VENUE_IMAGES`, `MOSAIC_IMAGES`, `inter`, `spaceGrotesk`, `metadata` (+166 more)
...
- **What connects `VENUE_IMAGES`, `MOSAIC_IMAGES`, `inter` to the rest of the system?**
